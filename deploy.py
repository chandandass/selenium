...
try:
    ...
    time.sleep(1)
    save_button = driver.find_element(By.XPATH, "//button[@debug-id='main-button']")
    save_button.click()
    time.sleep(2)
    appcontent_back_button = driver.find_element(By.XPATH, "//a[@aria-label='Go back to App content']")
